package com.example.postandreplyservice.security;
...
public class JwtProvider {
    ...
    public Optional<AuthUserDetail> resolveToken(HttpServletRequest request) throws InvalidTokenException {
        ...
        try {
            ...
            throw new InvalidTokenException("Invalid token, please try to login and get a new token.");
        }
    }
